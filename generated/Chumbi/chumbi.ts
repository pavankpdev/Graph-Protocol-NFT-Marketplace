...
export class chumbi extends ethereum.SmartContract {
  static bind(address: Address): chumbi {
    return new chumbi("chumbi", address);
  }
...
export class SetBatchURICall extends ethereum.Call {
  get inputs(): SetBatchURICall__Inputs {
    return new SetBatchURICall__Inputs(this);
  }

  get outputs(): SetBatchURICall__Outputs {
    return new SetBatchURICall__Outputs(this);
  }
}

export class SetBatchURICall__Inputs {
  _call: SetBatchURICall;

  constructor(call: SetBatchURICall) {
    this._call = call;
  }
...
export class SetBatchURICall__Outputs {
  _call: SetBatchURICall;
