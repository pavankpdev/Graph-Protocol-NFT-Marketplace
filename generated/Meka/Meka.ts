...
export class Meka extends ethereum.SmartContract {
  static bind(address: Address): Meka {
    return new Meka("Meka", address);
  }

  awardItem(player: Address, tokenURI: string): BigInt {
    let result = super.call(
      "awardItem",
      "awardItem(address,string):(uint256)",
      [ethereum.Value.fromAddress(player), ethereum.Value.fromString(tokenURI)]
    );
